...
const showcaseCards = [
  {
    ...
    number: '01',
    title: 'Dakhala — Unified Admissions',
    desc: "Pakistan's intelligent platform simplifying university admissions with accurate aggregate calculation and AI recommendations.",
  },
  {
